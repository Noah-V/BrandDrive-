...
<div class="branddrive-settings">
    ...
    <?php if ($form_submitted): ?>
        <div class="branddrive-notification <?php echo $form_error ? 'error' : 'success'; ?>">
            <p><?php echo esc_html($form_message); ?></p>
            <span class="close dashicons dashicons-no-alt"></span>
        </div>
    <?php endif; ?>

    <div id="branddrive_settings_notice" class="branddrive-notification" style="display: none;"></div>
    ...
    <form method="post" action="" class="branddrive-settings-form">
        ...
        <div class="branddrive-form-actions">
            <button type="submit" name="branddrive_save_settings" class="branddrive-button branddrive-button-primary"><?php _e('Save Settings', 'branddrive-woocommerce'); ?></button>
        </div>
    </form>
</div>
...
<script>
    jQuery(document).ready(function($) {
        // Close notification
        $('.branddrive-notification .close').on('click', function() {
            $(this).closest('.branddrive-notification').fadeOut();
        });
    });
</script>
